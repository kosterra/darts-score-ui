                ...
                <Fragment>
                    ...
                    <Row className="mb-3 p-3 border-dotted-bottom-grey">
                        ...
                        <Col className="d-flex justify-content-center align-items-center">
                            <div className="d-flex flex-column justify-content-center">
                                <Avatar
                                    name={`${players.find(player => player.id === game.players[2]).firstname} ${players.find(player => player.id === game.players[2]).lastname}`}
                                    src={ `${players.find(player => player.id === game.players[2]).profileImg}` }
                                    size="80"
                                    round={true}
                                    color="#565656"
                                    textSizeRatio={0.2}
                                ...
                                />
                                <div className="mt-2 align-self-center fs-7 fw-600">
                                    { players.find(player => player.id === game.players[2]).nickname }
                                </div>
                                <div className="align-self-center fs-7 fw-500">
                                    { players.find(player => player.id === game.players[2]).firstname } { players.find(player => player.id === game.players[2]).lastname }
                                </div>
                                <div className="align-self-center fs-1 fw-400">
