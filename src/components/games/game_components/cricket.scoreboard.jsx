                    ...
                    <Col className="d-flex flex-column justify-content-center align-items-center h-100">
                        <Row>
                            <div className="d-flex justify-content-center align-items-center h-50">
                                <div className="display-5 fw-600 mt-1" >
                        ...
                        <Row>
                            <div className="d-flex flex-column align-items-center justify-content-center w-100">
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(20) ? 'text-red text-strikethrough' : ''}`}>
                                        20
                                    </div>
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(19) ? 'text-red text-strikethrough' : ''}`}>
                                        19
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(18) ? 'text-red text-strikethrough' : ''}`}>
                                        18
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(17) ? 'text-red text-strikethrough' : ''}`}>
                                        17
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(16) ? 'text-red text-strikethrough' : ''}`}>
                                        16
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(15) ? 'text-red text-strikethrough' : ''}`}>
                                        15
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
                                ...
                                <div className="d-flex align-items-center w-75">
                                    <div className={`d-flex justify-content-center fw-600 mb-02 w-50 ${checkSectionClosed(25) ? 'text-red text-strikethrough' : ''}`}>
                                        BULL
                                    </div>
                                    <div className="d-flex justify-content-start align-items-center fs-8 w-50">
