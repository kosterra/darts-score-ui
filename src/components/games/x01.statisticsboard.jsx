        ...
        <Container className="p-0">
            <Row className="justify-content-md-center">
                <Col className="border-dotted-end-grey p-1 my-1 col-6">
                    <div>
                        <div className="h6 my-2 fw-semibold">Averages</div>
                        <div className="d-flex justify-content-between text-gray fs-9 border-solid-bottom-grey">
                        ...
                        <div className="d-flex justify-content-between text-gray fs-9">
                    ...
                    <div>
                        <div className="h6 my-2 fw-semibold">Amount</div>
                        <div className="d-flex justify-content-between text-gray fs-9">
                        ...
                        <div className="d-flex justify-content-between text-gray fs-9 mt-3">
                    ...
                    <div>
                        <div className="h6 my-2 fw-semibold">Checkout</div>
                        <div className="d-flex justify-content-between text-gray fs-9">
                        ...
                        <div className="d-flex justify-content-between text-gray fs-9 mb-3">
                        ...
                        {[...Array(20)].map((x, i) => ((game.playerModels[playerId].checkout || {}).sections || {})[i + 1] ? (
                            <div key={i + 1} className="d-flex justify-content-between text-gray fs-9">
                ...
                <Col className="p-1 my-1 col-6">
                    <div className="h6 my-2 fw-semibold">Per Round Score</div>
                    <div className="container">
                        <div className="row align-items-baseline mb-1" key="initial">
                            <span className="col-2 p-0 fw-semibold fs-8">Initial</span>
                            <span className="col-2 p-0 fs-9 text-gray text-end"> </span>
                            <span className="col-2 p-0 fs-9 text-gray text-end"> </span>
                            <span className="col-2 p-0 fs-9 text-gray text-end"> </span>
                            <span className="col-2 p-0 fs-9 fw-semibold text-gray text-end"> </span>
                            <span className="col-2 p-0 fw-semibold fs-8 text-end">501</span>
                        </div>
                        {game.currentLegThrows.filter(e => e.playerId === playerId).map((throws, index) => (
                            <div className="row align-items-baseline mb-1" key={index}>
                                <span className="col-2 p-0 fw-semibold fs-8">R{index + 1}</span>
                                <span className="col-2 p-0 fs-9 fst-italic text-gray text-end">{throws.darts[0]}</span>
                                <span className="col-2 p-0 fs-9 fst-italic text-gray text-end">{throws.darts[1]}</span>
                                <span className="col-2 p-0 fs-9 fst-italic text-gray text-end">{throws.darts[2]}</span>
                                <span className='col-2 p-0 fs-9 fw-semibold text-gray text-end'>{throws.roundScore}</span>
                                <span className="col-2 p-0 fw-semibold fs-8 text-end">{throws.scoreLeft}</span>
                            </div>
                        ))}
                    </div>
                </Col>
